...
![image](https://github.com/korm445/java-project/assets/152654984/460a769c-411e-46ee-93b0-768237a47f1c)
В файле всего 348 строк, 10 команд, в каждой по 30-38 игроков

Каждый игрок имеет такие характеристики как: Имя, Название команды, Позиция в команде, Рост(дюймы), Вес(фунты), Возраст(годы).
